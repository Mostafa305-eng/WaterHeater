...
# 2 "<built-in>" 2
# 1 "ExternalInterrupt.c" 2
# 13 "ExternalInterrupt.c"
...
# 13 "ExternalInterrupt.c" 2


# 1 "./ExternalInterrupt.h" 1
# 16 "./ExternalInterrupt.h"
# 1 "./std_types.h" 1
# 17 "./std_types.h"
...
typedef uint8 bool;
# 16 "./ExternalInterrupt.h" 2

# 1 "./common_macros.h" 1
# 17 "./ExternalInterrupt.h" 2
...
# 16 "ExternalInterrupt.c" 2
# 59 "ExternalInterrupt.c"
void ExternInt_Init(ExternInt_Cfg_s * pstr_ExternIntCfg)
{
 switch(pstr_ExternIntCfg->ExternInt_No)
 {
  ...
  case (0) :
   ...
   if ( ((void *)0) != pstr_ExternIntCfg->ExternInt_CBF_Ptr)
   {
                INT_SetCallBackFunc(0,&INTCON,0x02,pstr_ExternIntCfg->ExternInt_CBF_Ptr );
   }
   break;
  case (1) :
